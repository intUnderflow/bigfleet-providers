...
// lowercase [a-z2-7] chars, which fits Hetzner's 63-char, alphanumeric-bounded
// label-value rules.
...
// base user-data from its leading bytes, so a shell-script base is not
// misparsed as cloud-config.
