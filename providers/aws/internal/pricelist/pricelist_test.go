...
func TestOfferURL(t *testing.T) {
	got := OfferURL(DefaultBaseURL, "eu-west-1")
	want := "https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonEC2/current/eu-west-1/index.json"
	if got != want {
		t.Fatalf("OfferURL = %q, want %q", got, want)
	}
}
