...
var Catalog = []Behavior{
	...
	{ID: "B203", Area: "Transition Matrix / Errors", Profiles: []string{"core"}, Capability: "", Phase: 2, BlackBox: true,
		Title: "Drain on an Idle machine never uses FAILED_PRECONDITION and leaves the machine in Idle (out-of-position rejection, or an idempotent no-op when the kit holds Drain op history for the machine)"},
	{ID: "B204", Area: "Transition Matrix / Errors", Profiles: []string{"core", "cloud"}, Capability: "", Phase: 2, BlackBox: true,
		Title: "Delete out of position (Speculative/Configured) never uses FAILED_PRECONDITION and leaves the source state unchanged — an out-of-position rejection, Unimplemented, or (Speculative being Delete's own target) an idempotent no-op"},
	...
	{ID: "B302", Area: "Fencing", Profiles: []string{"core"}, Capability: "", Phase: 2, BlackBox: true,
		Title: "Fencing high-water marks are isolated per (shard_id, machine_id): one shard's high mark never fences another shard, AND a high mark on one machine never fences a lower token on a DIFFERENT machine of the same shard (the concurrent-execute-pool out-of-order case); each (shard, machine)'s own stale token is still rejected"},
	{ID: "B303", Area: "Fencing", Profiles: []string{"core"}, Capability: "", Phase: 2, BlackBox: true,
		Title: "On a single shard and machine, every not-strictly-newer (epoch,sequence) token is rejected with FAILED_PRECONDITION and every strictly-newer token advances the mark, lexicographically (a higher epoch with a low sequence advances and resets the sequence space)"},
	...
	{ID: "B311", Area: "Fencing", Profiles: []string{"core"}, Capability: "", Phase: 2, BlackBox: true,
	...
	{ID: "B701", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
	...
	{ID: "B702", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
		Title: "A Create whose actuator errors drives the machine to FAILED with a non-empty last_error"},
	{ID: "B703", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
	...
	{ID: "B704", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
	...
	{ID: "B705", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
		Title: "A FAILED machine is terminal-pending-cleanup: a re-issued mutation toward any target is rejected (non-FAILED_PRECONDITION) and the machine stays FAILED with last_error preserved verbatim (the shard recovers on a different slot, never in place)"},
	{ID: "B706", Area: "Timeouts & Failure", Profiles: []string{"fault"}, Capability: "Fault", Phase: 4, BlackBox: false,
	...
	{ID: "B1001", Area: "Durability / Restart Recovery", Profiles: []string{"durable"}, Capability: "Durable", Phase: 4, BlackBox: false,
	...
	{ID: "B1002", Area: "Durability / Restart Recovery", Profiles: []string{"durable"}, Capability: "Durable", Phase: 4, BlackBox: false,
	...
	{ID: "B1003", Area: "Durability / Restart Recovery", Profiles: []string{"durable"}, Capability: "Durable", Phase: 4, BlackBox: false,
	...
	{ID: "B1004", Area: "Durability / Restart Recovery", Profiles: []string{"durable"}, Capability: "Durable", Phase: 4, BlackBox: false,
		Title: "After restart, full inventory (machine ids and states) is recovered identically with no machine lost or duplicated"},
	{ID: "B1005", Area: "Durability / Restart Recovery", Profiles: []string{"durable"}, Capability: "Durable", Phase: 4, BlackBox: false,
	...
	{ID: "B1103", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1104", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1105", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1106", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1107", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1108", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
	...
	{ID: "B1109", Area: "Scale & Soak", Profiles: []string{"scale"}, Capability: "Scale", Phase: 5, BlackBox: true,
